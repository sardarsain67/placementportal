...
while($row=mysql_fetch_array($result)){
      ...
      echo"Batch : $row[8]-$row[9]<br><hr>";
      echo"<b>Criteria :</b> <br> Current % :$row[10] &nbsp Course %: $row[11]<br>";
      echo"<br>backlogs : $row[12]<br><hr>";
       if(!empty($row[14])){
      echo"<br>package(in lacs): $row[13] -&nbsp $row[14]<br>";}else{
        echo"<br>package(in lacs): $row[13] <br>";
      }
   ...
   echo"<a href='$row[20]' target=slist>Apply</a>";
  echo"</div>";
